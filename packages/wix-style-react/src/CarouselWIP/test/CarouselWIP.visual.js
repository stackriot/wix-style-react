...
const controlsTests = [
  ...
  {
    prop: 'sidesGradientColor',
    values: [undefined, '#F0F4F7', '#000000'],
  },
  {
    prop: 'infinite',
    values: [true, false],
...
const createDriver = () =>
  uniTestkitFactoryCreator(carouselWIPUniDriverFactory)({
...
const CarouselWrapper = ({ done, ...props }) => {
  ...
  return <CarouselWIP {...props} />;
};

export const runTests = (
  { themeName, testWithTheme } = { testWithTheme: i => i },
) => {
  visualize(`${themeName ? `${themeName}|` : ''}CarouselWIP`, () => {
    story('Controls', () => {
